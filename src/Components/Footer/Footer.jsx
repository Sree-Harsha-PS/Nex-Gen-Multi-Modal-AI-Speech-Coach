  ...
  return (
    ...
    <section className="footer">
        <div className="box-container">
          <div className="box">
            <h3>Address</h3>
            <a href="googlemaplink">PES University, Bengaluru</a>
        ...
        <div className="box">
            <h3>Contact Us </h3>
                ...
                <i className="fa">
                <a href="tel:+91 9886463984">+91 9886463984</a></i>  
                <br></br>
                <i className="fa">
                <a href="mailto:info.shubham@gmail.com">info@speechcoach.com</a></i>
            </div>
        <div className="box">
            <h3>Follow us</h3>
            <link
